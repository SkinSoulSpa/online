...
$default_image = 'https://skinsoulspa.sg/og/default.jpg?v=2';
...
if (strpos($path, '/artisans') !== false) {
    ...
    $new_image = 'https://skinsoulspa.sg/og/artisans.jpg?v=2';
    $new_width = '1376';
    $new_height = '768';
} elseif (strpos($path, '/sanctuary') !== false) {
    ...
    $new_image = 'https://skinsoulspa.sg/og/journal.jpg?v=2';
    $new_width = '1376';
    $new_height = '768';
    ...
    $new_image = 'https://skinsoulspa.sg/og/reservations.jpg?v=2';
    $new_width = '2752';
    $new_height = '1536';
}
