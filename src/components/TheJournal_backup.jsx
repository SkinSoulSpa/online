        ...
        <div style={{ 
          ...
          <div>
            ...
            <div style={{
              ...
              <p style={{ marginBottom: '1.5rem' }}>
                In our "Hydrating Facial" ritual, we utilise the specific botanical potency of the Hydra Global collection to retrain the skin’s architecture. To maintain this "post-treatment glow" at home, we recommend a two-step intervention:
              </p>
              <p>
      ...
      <JournalSection className="journal-fade" style={{ backgroundColor: 'transparent' }}> {/* Transparent to reveal curve */}
        <div style={{ maxWidth: '800px', textAlign: 'center' }}>
          ...
          <div style={{
            ...
            <p>
              True radiance is not forced; it is coaxed. Whether you are visiting us for a Detox Facial session or seeking advice on a regimen, our artisans focus on long-term structural health over temporary surface changes. We treat the skin as a living organ to be respected, not a problem to be conquered.
            </p>
          </div>
